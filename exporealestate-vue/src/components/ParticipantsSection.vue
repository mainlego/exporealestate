    ...
    const participants = ref([
      {
        ...
        image: '/exporealestate/assets/images/Высокопоставленные_гости.jpg',
        badge: 'VIP',
      ...
      },
      {
        ...
        image: '/exporealestate/assets/images/Опытные_инвесторы.png',
        badge: 'PRO',
        icon: `<svg width="32" height="32" viewBox="0 0 24 24" fill="white">
      ...
      },
      {
        ...
        image: '/exporealestate/assets/images/предприниматели_бизнесмены.jpg',
        badge: 'BUSINESS',
        icon: `<svg width="32" height="32" viewBox="0 0 24 24" fill="white">
      ...
      },
      {
        ...
        image: '/exporealestate/assets/images/Девелоперы_застройщики.jpg',
        badge: 'DEVELOPER',
        icon: `<svg width="32" height="32" viewBox="0 0 24 24" fill="white">
